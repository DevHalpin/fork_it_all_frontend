...
const Recipes = (props) => {
  ...
  const handleFavorite = () => {
    axios.put(`/api/twists/${twist.id}/favorite?type=favorite`, {
      twist_id: `${twist.id}`,
    });
  };
  ...
  return (
    ...
    <>
      <Container fluid>
        <TwistCreateModal show={isModalOpen} onHide={toggleCreateModal} />
        <TwistEditModal show={isModalOpen} onHide={toggleEditModal} />
        <Col>
          <DropdownButton
